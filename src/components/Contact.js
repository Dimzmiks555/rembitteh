    ...
    <div className='section' id="contact">
        <div className='container'>
            ...
            <div className='contact_block'>
                ...
                <div>
                    <h1>Александр</h1>
                    <p>Вы можете связаться с нами, просто позвонив на номер телефона, указанный ниже, отправить на письмо на почту, или воспользоваться WhatsApp, Viber или Telegram!   </p>
                    <h2>Телефон</h2>
